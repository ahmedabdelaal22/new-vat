...
class PurchaseInvoiceRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'invoice_items.purchase_price.*'=>'required|numeric|min:0|max:999999',
    ...
    public function messages(){
        return [
            ...
            'invoice_items.purchase_price.*.required'=>trans('validation.invoice_items.purchase_price.required'),
            'invoice_items.purchase_price.*.numeric'=>trans('validation.invoice_items.purchase_price.required'),
            'invoice_items.purchase_price.*.max'=>trans('validation.invoice_items.purchase_price.max'),
            'responsables.required'=>trans('validation.responsables.required'),

            // =>trans('validation.name.required')
        ];
    }
}
