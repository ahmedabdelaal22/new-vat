...
class ClientBalancesReportController extends ReportController
{
    ...
    public function __construct(Request $request)
    {
        ...
        $this->basicViewFolder = 'reports/client_balances';
        $this->basicRoute = 'reports/client_balances';
        ...
        foreach ($resources as $resource) {
            ...
            array_push($resources_array,
                array(
                    ...
                    "client_balance" => optional($resource->client)->balance,
