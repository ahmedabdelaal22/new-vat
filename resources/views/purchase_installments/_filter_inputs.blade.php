<div class="filter_section" style="display: none;">
    ...
    <div class="form-group m-form__group row">
        ...
        <div class="col-sm-6 col-md-4 form_input">
            <label for="purchase_invoice_id">{!! trans('main.purchase_invoice') !!}</label>
            {!! Form::select('purchase_invoice_id',[],null,['class'=>'select2 select2_ajax custom-select custom-select-sm form-control form-control-sm   ','id'=>'purchase_invoice_id'])!!}
        </div>
