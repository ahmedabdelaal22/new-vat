    ...
    <div class="m-portlet__body">
        <div class="form-group m-form__group row">
            ...
            <div class="col-lg-4 col-md-3 col-sm-12 form_input">
                <div id="m_table_1_filter" class="dataTables_filter">
                    ...
                    <input type="search" class="form-control form-control-sm  " placeholder="" id="serach"
                           name="search_query"
                           name="search_query"
                           aria-controls="m_table_1" autocomplete="off">
                </div>
            </div>
            <div class="col-lg-4 col-md-3 col-sm-12 form_input">
                <label for="date">{!! trans('main.date') !!}</label>
                <div class="input-daterange input-group">
                    <input type="text" class="form-control form-control-sm date-picker" name="date_start" autocomplete="off">
                    <div class="input-group-append">
                        <span class="span_to">To</span>
                    </div>
                    <input type="text" class="form-control form-control-sm date-picker" name="date_end" autocomplete="off">
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-3 col-sm-12 form_input">
                ...
                <div class="input-daterange input-group">
                    <input type="text" class="form-control form-control-sm date-picker" name="confirmed_at_start" autocomplete="off">
                    <div class="input-group-append">
                        <span class="span_to">To</span>
                    </div>
                    <input type="text" class="form-control form-control-sm date-picker" name="confirmed_at_end" autocomplete="off">
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 form_input">
                ...
                <div class="input-daterange input-group">
                    <input class="form-control form-control-sm" type="number" name="amount_start" autocomplete="off">
                    <div class="input-group-append">
                        <span class="span_to">To</span>
                    </div>
                    <input class="form-control form-control-sm" type="number" name="amount_end" autocomplete="off">
                </div>
            </div>
