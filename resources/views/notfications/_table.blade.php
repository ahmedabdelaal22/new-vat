                ...
                <tr class="table_tr" id="removable{{$resource->id}}">
                    ...
                    @if(Auth()->user()->is_super_admin ||
                     Auth()->user()->can($basicRoute.' edit')
                        ...
                        <!-- <a href="{!!route('notfications.edit',$resource->id)!!}" class="m-portlet__nav-link btn m-btn
                    m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill" data-toggle="m-tooltip" data-placement="top" title="" data-original-title="تعديل"> <i
                   ...
                   @if(Auth()->user()->is_super_admin ||
                     Auth()->user()->can($basicRoute.' destroy')
                        ...
                        <button class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill destroy delete_icon" data-toggle="m-tooltip" data-placement="top" title="" data-original-title="{{trans('main.delete')}}"
                            data-route="{!!route('notfications.destroy',$resource->id)!!}" data-token="">
