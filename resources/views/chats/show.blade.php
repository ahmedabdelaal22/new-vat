...
@section('breadcrumb')
@php($breadcrumbs=[trans('main.users')=>route('users.index'),trans('main.update_data')=>route('users.show',['id' => $resource->id])])
					...
					<div class="tab-pane active" id="m_user_profile_tab_1">
						<form class="m-form m-form--fit m-form--label-align-right">
							<div class="m-portlet__body">
								...
								{!! Form::model($resource,['method'=>'put','route'=>['users.update',$resource->id],'files'=>'true','class'=>'m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed'])!!}
                				@include('users._form')
							</div>
						...
						<table class="table table-striped- table-bordered dataTable table-hover table-checkable">
							...
							@foreach($resource->tasks as $task)
								<tr>
					               ...
					               <a href="{!!route('tasks.show',['id' => $task->id])!!}" class="m-portlet__nav-link btn m-btn
