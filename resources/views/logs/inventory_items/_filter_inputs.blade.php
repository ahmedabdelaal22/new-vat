...
<div class="m-portlet__body">
    <div class="form-group m-form__group row">
        ...
        <div class="col-sm-6 col-md-4 form_input">
            ...
            {!! Form::select('inventory_id',[],null,['class'=>'select2 select2_ajax custom-select custom-select-sm form-control form-control-sm   ', 'autocomplete'=>'off','id'=>'inventory_id'])!!}
        </div>

        <div class="col-sm-6 col-md-4 form_input">
            <label for="item_id">{!! trans('main.item') !!}</label>
            {!! Form::select('item_id',[],null,['class'=>'select2 select2_ajax custom-select custom-select-sm form-control form-control-sm   ','autocomplete'=>'off','id'=>'item_id'])!!}
        </div>


        <div class="col-sm-6 col-md-8 form_input"></div>
