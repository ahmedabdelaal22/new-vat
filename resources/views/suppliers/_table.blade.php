    ...
    <div class="col-sm-12">
        ...
        <table class="table table-bordered dataTable table-hover table-checkable
            ...
            <tr>
                ...
                <th class="sorting
                    {{(isset($date['sorttype']) && $date['sortby']=='email') ? 'sorting_'.$date['sorttype'] :''}}"
                    data-sorting_type="{{(isset($date['sorttype']) && $date['sortby']=='email') ? $date['sorttype'] :'asc'}}"
                    data-column_name="email" style="cursor: pointer">{!!
                        trans('main.email') !!}
                    <span id="email_icon"></span>
                </th>
                <th class="sorting
                    {{(isset($date['sorttype']) && $date['sortby']=='phone') ? 'sorting_'.$date['sorttype'] :''}}"
                    data-sorting_type="{{(isset($date['sorttype']) && $date['sortby']=='phone') ? $date['sorttype'] :'asc'}}"
