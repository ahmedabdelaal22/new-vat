...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>Metronic | Basic Calendar</title>
						...
						<div class="m-stack__item m-brand  m-brand--skin-dark ">
							<div class="m-stack m-stack--ver m-stack--general">
								<div class="m-stack__item m-stack__item--middle m-brand__logo">
									<a href="{!!url('dashboard')!!}/index.html" class="m-brand__logo-wrapper">
										<img alt="" src="{!!asset('dashboard')!!}/assets/demo/default/media/img/logo/logo_default_dark.png" />
									</a>
								</div>
										...
										<div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--left">
											...
											<ul class="m-menu__subnav">
												<li class="m-menu__item " aria-haspopup="true">
													<a href="{!!url('dashboard')!!}/header/actions.html" class="m-menu__link ">
									...
									<li class="m-menu__item  m-menu__item--submenu m-menu__item--rel" m-menu-submenu-toggle="click" m-menu-link-redirect="1" aria-haspopup="true">
										...
										<div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--left">
											...
											<ul class="m-menu__subnav">
												...
												<li class="m-menu__item  m-menu__item--submenu" m-menu-submenu-toggle="hover" m-menu-link-redirect="1" aria-haspopup="true">
													<a href="{!!url('dashboard')!!}/crud/datatable_v1.html" class="m-menu__link m-menu__toggle">
										...
										<li class="m-nav__item m-topbar__languages m-dropdown m-dropdown--small m-dropdown--arrow m-dropdown--align-right m-dropdown--mobile-full-width" m-dropdown-toggle="click">
											<a href="#" class="m-nav__link m-dropdown__toggle">
												<span class="m-nav__link-text">
													<img class="m-topbar__language-selected-img" src="{!!asset('dashboard')!!}/assets/app/media/img/flags/020-flag.svg">
												</span>
											</a>
											<div class="m-dropdown__wrapper">
												<span class="m-dropdown__arrow m-dropdown__arrow--right m-dropdown__arrow--adjust"></span>
															...
															<ul class="m-nav m-nav--skin-light">
																<li class="m-nav__item m-nav__item--active">
																	<a href="#" class="m-nav__link m-nav__link--active">
																		<span class="m-nav__link-icon">
																			<img class="m-topbar__language-img" src="{!!asset('dashboard')!!}/assets/app/media/img/flags/020-flag.svg">
																		</span>
																...
																<li class="m-nav__item">
																	<a href="#" class="m-nav__link">
																		<span class="m-nav__link-icon">
																			<img class="m-topbar__language-img" src="{!!asset('dashboard')!!}/assets/app/media/img/flags/015-china.svg">
																		</span>
																...
																<li class="m-nav__item">
																	<a href="#" class="m-nav__link">
																		<span class="m-nav__link-icon">
																			<img class="m-topbar__language-img" src="{!!asset('dashboard')!!}/assets/app/media/img/flags/016-spain.svg">
																		</span>
																...
																<li class="m-nav__item">
																	<a href="#" class="m-nav__link">
																		<span class="m-nav__link-icon">
																			<img class="m-topbar__language-img" src="{!!asset('dashboard')!!}/assets/app/media/img/flags/014-japan.svg">
																		</span>
																...
																<li class="m-nav__item">
																	<a href="#" class="m-nav__link">
																		<span class="m-nav__link-icon">
																			<img class="m-topbar__language-img" src="{!!asset('dashboard')!!}/assets/app/media/img/flags/017-germany.svg">
																		</span>
													...
													<div class="m-dropdown__body">
														<div class="m-dropdown__content">
															<ul class="m-nav m-nav--skin-light">
																...
																<li class="m-nav__item">
																	<a href="{!!url('dashboard')!!}/header/profile.html" class="m-nav__link">
																...
																<li class="m-nav__item">
																	<a href="{!!url('dashboard')!!}/snippets/pages/user/login-1.html" class="btn m-btn--pill    btn-secondary m-btn m-btn--custom m-btn--label-brand m-btn--bolder">Logout</a>
																</li>
															</ul>
														</div>
													</div>
				...
				<div id="m_aside_left" class="m-grid__item	m-aside-left  m-aside-left--skin-dark ">
					...
					<div id="m_ver_menu" class="m-aside-menu  m-aside-menu--skin-dark m-aside-menu--submenu-skin-dark " m-menu-vertical="1" m-menu-scrollable="1" m-menu-dropdown-timeout="500" style="position: relative;">
						<ul class="m-menu__nav  m-menu__nav--dropdown-submenu-arrow ">
							<li class="m-menu__item " aria-haspopup="true">
								<a href="{!!url('dashboard')!!}/index.html" class="m-menu__link ">
									<i class="m-menu__link-icon flaticon-line-graph"></i>
									<span class="m-menu__link-title">
										<span class="m-menu__link-wrap">
							...
							<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true">
								...
								<div class="m-menu__submenu ">
									...
									<ul class="m-menu__subnav">
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/components/base/state.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/components/base/typography.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/components/base/stack.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/components/base/tables.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/components/base/progress.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/components/base/modal.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/components/base/alerts.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/components/base/popover.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/components/base/tooltip.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/components/base/blockui.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/components/base/spinners.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/components/base/scrollable.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/components/base/dropdown.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
										...
										<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true">
											...
											<div class="m-menu__submenu ">
												...
												<ul class="m-menu__subnav">
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/components/base/tabs/bootstrap.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/components/base/tabs/line.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/components/base/accordions.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/components/base/navs.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/components/base/lists.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/components/base/treeview.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/components/base/bootstrap-notify.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/components/base/toastr.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/components/base/sweetalert2.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
							...
							<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true">
								...
								<div class="m-menu__submenu ">
									...
									<ul class="m-menu__subnav">
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/components/icons/flaticon.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/components/icons/fontawesome5.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/components/icons/lineawesome.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/components/icons/socicons.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
									...
									<ul class="m-menu__subnav">
										...
										<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true">
											...
											<div class="m-menu__submenu ">
												...
												<ul class="m-menu__subnav">
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/components/buttons/base/default.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/components/buttons/base/square.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/components/buttons/base/pill.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/components/buttons/base/air.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/components/buttons/group.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/components/buttons/dropdown.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
										...
										<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true">
											...
											<div class="m-menu__submenu ">
												...
												<ul class="m-menu__subnav">
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/components/buttons/icon/lineawesome.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/components/buttons/icon/fontawesome.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/components/buttons/icon/flaticon.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
							...
							<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true">
								...
								<div class="m-menu__submenu ">
									...
									<ul class="m-menu__subnav">
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/components/portlets/base.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/components/portlets/advanced.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/components/portlets/creative.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/components/portlets/tabbed.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/components/portlets/draggable.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/components/portlets/tools.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/components/portlets/sticky-head.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
							...
							<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true">
								...
								<div class="m-menu__submenu ">
									...
									<ul class="m-menu__subnav">
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/components/timeline/timeline-1.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/components/timeline/timeline-2.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
							...
							<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true">
								...
								<div class="m-menu__submenu ">
									...
									<ul class="m-menu__subnav">
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/components/widgets/general.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/components/widgets/chart.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
								...
								<div class="m-menu__submenu ">
									...
									<ul class="m-menu__subnav">
										...
										<li class="m-menu__item  m-menu__item--active" aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/components/calendar/basic.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/components/calendar/list-view.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/components/calendar/google.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/components/calendar/external-events.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/components/calendar/background-events.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
									...
									<ul class="m-menu__subnav">
										...
										<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true">
											...
											<div class="m-menu__submenu ">
												...
												<ul class="m-menu__subnav">
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/components/charts/amcharts/charts.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/components/charts/amcharts/stock-charts.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/components/charts/amcharts/maps.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/components/charts/flotcharts.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/components/charts/google-charts.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/components/charts/morris-charts.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
							...
							<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true">
								...
								<div class="m-menu__submenu ">
									...
									<ul class="m-menu__subnav">
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/components/maps/google-maps.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/components/maps/jqvmap.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
							...
							<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true">
								...
								<div class="m-menu__submenu ">
									...
									<ul class="m-menu__subnav">
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/components/utils/session-timeout.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/components/utils/idle-timer.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
									...
									<ul class="m-menu__subnav">
										...
										<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true">
											...
											<div class="m-menu__submenu ">
												...
												<ul class="m-menu__subnav">
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/forms/controls/base.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/forms/controls/checkbox-radio.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/forms/controls/input-group.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/forms/controls/switch.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/forms/controls/option.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
										...
										<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true">
											...
											<div class="m-menu__submenu ">
												...
												<ul class="m-menu__subnav">
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/forms/widgets/bootstrap-datepicker.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/forms/widgets/bootstrap-datetimepicker.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/forms/widgets/bootstrap-timepicker.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/forms/widgets/bootstrap-daterangepicker.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/forms/widgets/bootstrap-touchspin.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/forms/widgets/bootstrap-maxlength.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/forms/widgets/bootstrap-switch.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
															<span class="m-menu__link-text">Switch</span>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/forms/widgets/bootstrap-multipleselectsplitter.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/forms/widgets/bootstrap-select.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/forms/widgets/select2.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/forms/widgets/typeahead.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/forms/widgets/nouislider.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/forms/widgets/form-repeater.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/forms/widgets/ion-range-slider.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/forms/widgets/input-mask.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/forms/widgets/summernote.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/forms/widgets/bootstrap-markdown.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/forms/widgets/autosize.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/forms/widgets/clipboard.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/forms/widgets/dropzone.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/forms/widgets/recaptcha.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
										...
										<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true">
											...
											<div class="m-menu__submenu ">
												...
												<ul class="m-menu__subnav">
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/forms/layouts/default-forms.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/forms/layouts/multi-column-forms.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/forms/layouts/action-bars.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/forms/layouts/sticky-action-bar.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
										...
										<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true">
											...
											<div class="m-menu__submenu ">
												...
												<ul class="m-menu__subnav">
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/forms/validation/states.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/forms/validation/form-controls.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
															<span class="m-menu__link-text">Form Controls</span>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/forms/validation/form-widgets.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
															<span class="m-menu__link-text">Form Widgets</span>
							...
							<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true">
								...
								<div class="m-menu__submenu ">
									...
									<ul class="m-menu__subnav">
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/crud/wizard/wizard-1.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/crud/wizard/wizard-2.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/crud/wizard/wizard-3.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/crud/wizard/wizard-4.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/crud/wizard/wizard-5.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
									...
									<ul class="m-menu__subnav">
										...
										<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true">
											...
											<div class="m-menu__submenu ">
												...
												<ul class="m-menu__subnav">
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/metronic-datatable/base/data-local.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/metronic-datatable/base/data-json.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/metronic-datatable/base/data-ajax.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/metronic-datatable/base/html-table.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/metronic-datatable/base/record-selection.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/metronic-datatable/base/local-sort.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/metronic-datatable/base/row-details.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/metronic-datatable/base/column-rendering.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/metronic-datatable/base/column-width.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/metronic-datatable/base/responsive-columns.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/metronic-datatable/base/translation.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
										...
										<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true">
											...
											<div class="m-menu__submenu ">
												...
												<ul class="m-menu__subnav">
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/metronic-datatable/scrolling/vertical.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/metronic-datatable/scrolling/horizontal.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/metronic-datatable/scrolling/both.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
										...
										<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true">
											...
											<div class="m-menu__submenu ">
												...
												<ul class="m-menu__subnav">
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/metronic-datatable/locked/left.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/metronic-datatable/locked/right.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/metronic-datatable/locked/both.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/metronic-datatable/locked/html-table.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
															<span class="m-menu__link-text">HTML Table</span>
										...
										<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true">
											...
											<div class="m-menu__submenu ">
												...
												<ul class="m-menu__subnav">
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/metronic-datatable/child/data-local.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
															<span class="m-menu__link-text">Local Data</span>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/metronic-datatable/child/data-ajax.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
										...
										<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true">
											...
											<div class="m-menu__submenu ">
												...
												<ul class="m-menu__subnav">
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/metronic-datatable/api/methods.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/metronic-datatable/api/events.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
									...
									<ul class="m-menu__subnav">
										...
										<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true">
											...
											<div class="m-menu__submenu ">
												...
												<ul class="m-menu__subnav">
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/datatables/basic/basic.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/datatables/basic/scrollable.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/datatables/basic/headers.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/datatables/basic/paginations.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
										...
										<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true">
											...
											<div class="m-menu__submenu ">
												...
												<ul class="m-menu__subnav">
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/datatables/advanced/column-rendering.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
															<span class="m-menu__link-text">Column Rendering</span>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/datatables/advanced/multiple-controls.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/datatables/advanced/column-visibility.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/datatables/advanced/row-callback.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/datatables/advanced/row-grouping.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/datatables/advanced/footer-callback.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
										...
										<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true">
											...
											<div class="m-menu__submenu ">
												...
												<ul class="m-menu__subnav">
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/datatables/data-sources/html.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/datatables/data-sources/javascript.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/datatables/data-sources/ajax-client-side.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/datatables/data-sources/ajax-server-side.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
										...
										<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true">
											...
											<div class="m-menu__submenu ">
												...
												<ul class="m-menu__subnav">
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/datatables/search-options/column-search.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/datatables/search-options/advanced-search.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
										...
										<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true">
											...
											<div class="m-menu__submenu ">
												...
												<ul class="m-menu__subnav">
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/datatables/extensions/buttons.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
															<span class="m-menu__link-text">Buttons</span>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/datatables/extensions/colreorder.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/datatables/extensions/keytable.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/datatables/extensions/responsive.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/datatables/extensions/rowgroup.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/datatables/extensions/rowreorder.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/datatables/extensions/scroller.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a href="{!!url('dashboard')!!}/crud/datatables/extensions/select.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
							...
							<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true">
								...
								<div class="m-menu__submenu ">
									...
									<ul class="m-menu__subnav">
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/snippets/general/pricing-tables/pricing-table-1.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/snippets/general/pricing-tables/pricing-table-2.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/snippets/general/pricing-tables/pricing-table-3.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/snippets/general/pricing-tables/pricing-table-4.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
							...
							<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true">
								...
								<div class="m-menu__submenu ">
									...
									<ul class="m-menu__subnav">
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/snippets/invoices/invoice-1.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/snippets/invoices/invoice-2.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
							...
							<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true">
								...
								<div class="m-menu__submenu ">
									...
									<ul class="m-menu__subnav">
										...
										<li class="m-menu__item " aria-haspopup="true">
											<a href="{!!url('dashboard')!!}/snippets/faq/faq-1.html" class="m-menu__link ">
												<i class="m-menu__link-bullet m-menu__link-bullet--dot">
													<span></span>
												</i>
									...
									<ul class="m-menu__subnav">
										...
										<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true">
											...
											<div class="m-menu__submenu ">
												...
												<ul class="m-menu__subnav">
													<li class="m-menu__item " aria-haspopup="true">
														<a target="_blank" href="{!!url('dashboard')!!}/snippets/pages/user/login-1.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a target="_blank" href="{!!url('dashboard')!!}/snippets/pages/user/login-2.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a target="_blank" href="{!!url('dashboard')!!}/snippets/pages/user/login-3.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a target="_blank" href="{!!url('dashboard')!!}/snippets/pages/user/login-4.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a target="_blank" href="{!!url('dashboard')!!}/snippets/pages/user/login-5.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a target="_blank" href="{!!url('dashboard')!!}/snippets/pages/user/login-6.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
										...
										<li class="m-menu__item  m-menu__item--submenu" aria-haspopup="true">
											...
											<div class="m-menu__submenu ">
												...
												<ul class="m-menu__subnav">
													<li class="m-menu__item " aria-haspopup="true">
														<a target="_blank" href="{!!url('dashboard')!!}/snippets/pages/errors/error-1.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a target="_blank" href="{!!url('dashboard')!!}/snippets/pages/errors/error-2.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a target="_blank" href="{!!url('dashboard')!!}/snippets/pages/errors/error-3.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a target="_blank" href="{!!url('dashboard')!!}/snippets/pages/errors/error-4.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a target="_blank" href="{!!url('dashboard')!!}/snippets/pages/errors/error-5.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
													...
													<li class="m-menu__item " aria-haspopup="true">
														<a target="_blank" href="{!!url('dashboard')!!}/snippets/pages/errors/error-6.html" class="m-menu__link ">
															<i class="m-menu__link-bullet m-menu__link-bullet--dot">
																<span></span>
															</i>
						...
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								...
								<ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
									...
									<li class="m-nav__item">
										<a href="" class="m-nav__link">
											<span class="m-nav__link-text">Basic Calendar</span>
										</a>
									</li>
								</ul>
							</div>
								...
								<div class="m-messenger__wrapper">
									<div class="m-messenger__message m-messenger__message--in">
										<div class="m-messenger__message-pic">
											<img src="{!!asset('dashboard')!!}/assets/app/media/img//users/user3.jpg" alt="" />
										</div>
