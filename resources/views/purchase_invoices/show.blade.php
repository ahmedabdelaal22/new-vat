 ...
 <div class="m-portlet m-portlet--mobile">
    ...
    <div class="m-portlet__body ">
        <div class="row">
        	...
        	<div class="col-md-6 form-group">
        		<label>{{__('main.purchase_invoice_number')}} : </label>
        		<label>{{$resource->purchase_invoice_number}}</label>
        	</div>
        	...
        	<div class="col-md-6 form-group">
        		...
        		<label>{{optional($resource->supplier)->name}}</label>
        	</div>
        	<div class="col-md-6 form-group">
            ...
            <div class="col-md-6 form-group">
                <label>{{__('main.paid_amount')}} : </label>
                <label>{{$resource->paid_amount}}</label>
            </div>
