...
<div class="m-portlet__body">
    <div class="form-group m-form__group row">
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 form_input">
            <label for="remaining_amount"><?php echo trans('main.remaining_amount'); ?></label>
...
<?php /**PATH /var/www/html/invoices/resources/views/sales_invoices/_filter_inputs.blade.php ENDPATH**/ ?>