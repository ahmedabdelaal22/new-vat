<div class="m-portlet__body">
    <div class="form-group m-form__group row form_space">
        ...
        <div class="col-lg-4">
            <label for="code"><?php echo trans('main.code'); ?></label>
            <?php echo Form::text('code',$resource->code,['class'=>'form-control
        ...
        <div class="col-lg-4">
            ...
            <?php echo Form::text('date',(!empty($resource->date) ? Carbon\Carbon::parse($resource->date)->format('Y/m/d') : Carbon\Carbon::now()->format('Y/m/d')),['class'=>'form-control
            m-input date-picker','autocomplete'=>'off','id'=>'date','placeholder'=>trans('main.date')]); ?>

        </div>

        <div class="col-lg-4">
            <label for="supplier"><?php echo trans('main.client'); ?></label>
            <?php echo Form::select('client_id',App\Models\Client::
        ...
        <div class="col-lg-4">
            <label for="supplier"><?php echo trans('main.inventory'); ?></label>
            <?php echo Form::select('inventory_id',App\Models\Inventory::
        ...
        <div class="col-lg-4">
            <label for="supplier"><?php echo trans('main.currency'); ?></label>
            <?php echo Form::select('currency_id',App\Models\Currency::
    ...
    <div class="form-group m-form__group">
        <table class="table table-bordered dataTable table-hover table-checkable
            ...
            <thead>
                ...
                <th style="width: 111px!important">
                    <?php echo e(__('main.sale_price')); ?>

                </th>
                <th style="width: 111px!important">
                    <?php echo e(__('main.unit_price')); ?>

                </th>
                <th style="width: 111px!important">
                    <?php echo e(__('main.purchase_price')); ?>
                ...
                <th style="width: 111px!important">
                    <?php echo e(__('main.notes')); ?>

                </th>
                <th style="width: 50px!important">
                    <?php echo e(__('main.delete')); ?>
            ...
            <tr>
                <td colspan="8">
                    <button class="btn btn-success btn-sm" id="addTableRow">
                        ...
                        <span style="font-weight: bold;"><?php echo e(trans('main.add')); ?></span>
                    </button>
                </td>
            </tr>
            </tfoot>
    ...
    <div class="form-group m-form__group row">
        ...
        ?>
        <?php $__currentLoopData = App\Models\Tax::get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tax): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="col-lg-2">
            <label for="<?php echo e($tax->name.'_'.$tax->id); ?>" class="d-flex sales_order_check">
                <input class=" form-check taxes calculateTotal" id="<?php echo e($tax->name.'_'.$tax->id); ?>" type="checkbox" name="taxes[]" value="<?php echo e($tax->id); ?>" data-options='<?php echo $tax; ?>' <?php echo e(in_array($tax->id,$selectTaxes) ? "checked":""); ?>>
    ...
    <div class="form-group m-form__group row">
        ...
        <div class="col-lg-3">
            <label for="total"><?php echo trans('main.total'); ?></label>
            <?php echo Form::text('total',(!empty($resource->total)) ? $resource->total : 0,['class'=>'form-control
            m-input','id'=>'total','placeholder'=>trans('main.total'),'readonly']); ?>

        </div>

        <div class="col-lg-3">
            <label for="discount_type"><?php echo trans('main.discount_type'); ?></label>
            <?php echo Form::select('discount_type',['percent'=>trans('main.percent').' % ','fixed'=>trans('main.fixed_amount')],$resource->discount_type,['class'=>'form-control
            m-input select2','id'=>'discount_type']); ?>

        </div>
        <div class="col-lg-3">
            <label for="paid_amount"><?php echo trans('main.discount_amount'); ?></label>
            <?php echo Form::text('discount_amount',(!empty($resource->discount_amount)) ? $resource->discount_amount : 0,['class'=>'form-control
        ...
        <div class="col-lg-3">
            <label for="total_after_discount">
                <?php echo trans('main.total_after_discount'); ?>

            </label>
            <?php echo Form::text('total_after_discount',(!empty($resource->total_after_discount)) ? $resource->total_after_discount : 0,['class'=>'form-control
    ...
    <div class="form-group m-form__group row">
        ...
        <div class="col-lg-3">
            ...
            <?php echo Form::text('final_total',(!empty($resource->final_total)) ? $resource->final_total : 0,['class'=>'form-control
            m-input','id'=>'final_total','placeholder'=>trans('main.final_total'),'readonly']); ?>

        </div>

        <div class="col-lg-3">
            <label for="payment_type"><?php echo trans('main.payment_type'); ?></label>
            <?php echo Form::select('payment_type',['cash'=>trans('main.cash'),'post_paid'=>trans('main.post_paid')],$resource->payment_type,['class'=>'form-control
            m-input select2','id'=>'payment_type']); ?>

        </div>

        <div class="col-lg-3">
            <label for="paid_amount"><?php echo trans('main.paid_amount'); ?></label>
            <?php echo Form::text('paid_amount',(!empty($resource->paid_amount)) ? $resource->paid_amount : 0,['class'=>'form-control
        ...
        <div class="col-lg-3">
            ...
            <?php echo Form::text('remaining_amount',(!empty($resource->remaining_amount)) ? $resource->remaining_amount : 0 ,['class'=>'form-control
    ...
    <div class="form-group m-form__group row">
        <div class="col-lg-12">
            ...
            <?php echo Form::textarea('notes',$resource->notes,['class'=>'form-control
    ...
    <div class="form-group m-form__group row" id="invoiceInstallment" style="display: none;">
        <div class="col-md-12">
            <label><?php echo e(__('main.installments')); ?></label>
            <table class="table table-bordered dataTable table-hover table-checkable
                         table-striped m-table m-table--head-bg-success custom_table"
                   id="InvoiceInstallmentTableData">
                <thead>
                <th>
                    <?php echo e(__('main.money_amount')); ?>

                </th>

                <th>
                    <?php echo e(__('main.date')); ?>
...
<?php $__env->startSection('scripts'); ?>
    <script type="text/javascript">
        ...
        <?php $__currentLoopData = $resource->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        $('#InvoiceTableData tbody').append(tableRow(<?php echo $item; ?>));
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        calculateTotal();
    ...
    $(document).on('click','#addTableRow',function(e){
        ...
        if(inventorty_id==''){
            $.confirm({
                title: "<?php echo e(trans('main.chose_inventort')); ?>",
                content: "<?php echo e(trans('main.chose_inventort')); ?>",
                type: 'red',
                buttons: {
                    cancel:{
        ...
        var route = "<?php echo url('ajax_json_item'); ?>/"+inventorty_id;
...
return input;
        ...
        function installmentTableRow(row = null) {
            ...
            var rowHtml = '<tr>'
                ...
                + '</td>'
                + '<td>'
                + '<input type="text" name="invoice_installments[date][]" class="form-control date-picker" value="<?php echo Carbon\Carbon::now()->format("m/d/Y"); ?>">'
                + '</td>'
                + '<td>'
...
<?php /**PATH /var/www/html/invoices/resources/views/sales_invoices/_form.blade.php ENDPATH**/ ?>