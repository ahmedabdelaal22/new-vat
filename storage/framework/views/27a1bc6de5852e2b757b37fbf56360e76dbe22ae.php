...
$(document).ready(function(){
    ...
    socket.on('get_login_user_id', function(data){
        <?php if(Auth()->check()): ?>
            socket.emit('loginUserId', {user_id : "<?php echo Auth()->user()->id; ?>"})
        <?php endif; ?>
    });
...
$(document).on('keyup','.getChatBoxUsers',function(e){
    ...
    e.preventDefault();
    // $('#load').addClass('show');
    var route = "<?php echo e(route('chats.get_users_box')); ?>";

    $.ajax({
        url: "<?php echo e(route('chats.get_users_box')); ?>",
        data:{
...
</script><?php /**PATH /var/www/html/invoices/resources/views/layouts/client_real_time_scripts.blade.php ENDPATH**/ ?>