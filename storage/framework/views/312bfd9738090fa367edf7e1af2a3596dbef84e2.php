              ...
              <div class="input-group search_chat">
                ...
                <div class="m-portlet__body chat_users_scroll">
                    ...
                    <div class="m-widget3" id="chatBoxUsers">
                        ...
                        <?php echo $__env->make('chats.chat_box_users',['users'=>App\Models\User::where('id','!=',Auth()->user()->id)->orderBy('is_online','DESC')->get()], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
    ...
    </div><?php /**PATH /var/www/html/invoices/resources/views/layouts/chat.blade.php ENDPATH**/ ?>